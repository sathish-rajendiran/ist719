...
shows.Type.more <- shows.Type[shows.Type$Year >=2010,]
shows.Type.more
...
gg + scale_x_continuous(labels = x_axis_labels, breaks = x_axis_labels)
...
shows.Released.more <- shows.Released[ shows.Released$Year >=2010,]
...
gg1 <- gg1 + theme()
gg1 + scale_x_continuous(labels = x_axis_labels, breaks = x_axis_labels)
